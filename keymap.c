...
[BASE] = KEYMAP(
        ...
        KC_DELT,        KC_Q,       KC_W,     KC_E,          KC_R,   KC_T,     KC_MHEN,
        KC_LCTL,LT(SYMB,KC_A),      KC_S,     KC_D,          KC_F,   KC_G,
        KC_LSFT,        KC_Z,       KC_X,     KC_C,          KC_V,   KC_B,     KC_GRV,
        KC_GRV,         KC_LEFT,    KC_RGHT,  KC_LALT,       KC_LGUI,
        ...
        // right hand
             ...
             KC_HENK,       KC_Y,   KC_U,   KC_I,   KC_O,   KC_P,             KC_MINS,
                          KC_H,   KC_J,   KC_K,   KC_L,   LT(MDIA, KC_SCLN),LT(MDIA,KC_QUOT),
             KC_NO,     KC_N,   KC_M,   KC_COMM,KC_DOT, CTL_T(KC_SLSH),   KC_RSFT,
                                  KC_DOWN,KC_UP,  KC_LBRC,KC_RBRC,          DF(BASE),
...
[SYMB] = KEYMAP(
       ...
       KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_HASH,
                                       KC_TRNS,  RESET,
                                               KC_TRNS,
       ...
       KC_TRNS, KC_AMPR, KC_1,   KC_2,    KC_3,    KC_BSLS, KC_TRNS,
                         KC_TRNS,KC_DOT,  KC_0,    KC_EQL,  DF(BASE),
       KC_TRNS, KC_TRNS,
       KC_TRNS,
       KC_TRNS, KC_TRNS, KC_TRNS
),
...
[MDIA] = KEYMAP(
    ...
    // right hand
       ...
       KC_TRNS,  KC_TRNS, KC_TRNS, KC_MPRV, KC_MNXT, KC_TRNS, KC_TRNS,
                          KC_VOLU, KC_VOLD, KC_MUTE, KC_TRNS, DF(BASE),
       KC_TRNS, KC_WBAK,
       KC_TRNS,
